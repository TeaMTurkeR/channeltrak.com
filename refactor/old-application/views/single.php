<?php 
	...
	$data['title'] = $row->song_title.' | Channeltrak';
			...
			<div class="large-12 columns">
				<section class="content">
					...
					<footer class="caption">
						...
						<p class="source"><span class="iconic home"></span><a href="<?php echo base_url(); ?>channel/<?php echo $row->song_channel_slug ?>"><?php echo $row->song_channel_name ?></a></p>
					</footer>
				</section>
